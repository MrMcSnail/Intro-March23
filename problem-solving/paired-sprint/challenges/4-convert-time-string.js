...
runTest("returns the string unchanged if already within the right format", function () {
...
skipTest("converts times in the hour after midnight to the 12 hour format", function () {
